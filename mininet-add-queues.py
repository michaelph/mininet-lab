...
for sw in switches:
        queuecmd = "sudo ovs-vsctl %s -- --id=@defaultqos create qos type=linux-htb other-config:max-rate=1000000000 queues=0=@q0,1=@q1,2=@q2 -- --id=@q0 create queue other-config:min-rate=500000000 other-config:max-rate=500000000 -- --id=@q1 create queue other-config:min-rate=300000000 other-config:max-rate=300000000 -- --id=@q2 create queue other-config:max-rate=200000000 other-config:min-rate=200000000" % config_strings[sw]
