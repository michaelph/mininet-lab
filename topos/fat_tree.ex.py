class Fattree(Topo):
    ...
    def __init__(self, k, density): # K is the number of fat tree pod. density is the number of host tor under.  
    ...
    """
    Add Link  createLink function is used to create links, modify the original version of the the death writing code. 
